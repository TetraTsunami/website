  ...
  return (
    <div className="border-bkg ring-accent group relative block w-full overflow-hidden rounded-xl border-2 bg-white/10 shadow-lg transition-transform duration-200 hover:scale-105 hover:ring-4">
      <Link
        ...
        className="group relative flex w-full items-center gap-4 p-2 lg:flex-col"
      >
        <Image
          src={data.excerptImageUrl}
          alt={data.excerptImageAlt}
          width={500}
          height={300}
          className="max-w-1/3 h-52 rounded-lg object-cover lg:w-full lg:max-w-full"
        />
        <div>
