...
isVisible: true
date: "2025-4-16"
excerptImageUrl: "/images/portfoliotemplate.png"
...
![A screenshot of a blank portfolio website](/images/portfoliotemplate.png)
    ...
    <div class="blog-grid">
      {sortedPosts.map(post => (
        <div class="blog-card">
          ...
          <a href={`/blog/${post.slug}`}>Read More <i class="fa-solid fa-arrow-right"></i></a>
        </div>
      ))}
    </div>
  </div>
